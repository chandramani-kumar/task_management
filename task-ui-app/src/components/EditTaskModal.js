...
const EditTaskModal = ({ task, onSave, onClose }) => {
    ...
    useEffect(() => {
        ...
        setEditedTask({...task, dueDate: formattedDate});
    }, [task]);
            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit} className="modal-body">
                    <div className="form-grid">
                        ...
                        <div className="form-field">
                            <label htmlFor="task-assignee">Assignee(s)</label>
                            <select id="task-assignee" name="assignee" value={editedTask.assignee} onChange={handleChange}>
                                {ASSIGNEE_OPTIONS.map(opt => <option key={opt} value={opt}>{opt}</option>)}
                            </select>
                        </div>
                        <div className="form-field">
                            <label htmlFor="task-due-date">Due Date</label>
                            <input id="task-due-date" type="date" name="dueDate" value={editedTask.dueDate} onChange={handleChange} />
                        </div>
